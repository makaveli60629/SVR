...
(()=>{
  ...
  function route(){if(state.quest)return'/game/quest.html?v=phase396';if(state.ios)return'/game/iphone.html?v=phase400';if(state.android)return'/game/android.html?channel=stable&v=phase405';return'/game/camera3-showcase.html?v=phase392'}
