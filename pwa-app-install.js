(() => {
  const BUILD = 'PHASE-110-SITE-APP-BUTTON-TO-MODULAR-DOWNLOADS';
  ...
  function boot() {
    ...
    addHeadLinks(); addStyles(); placeSiteMenuButton(); placeNavButton(); wireButtons(); installServiceWorker();
