...
foreach ($prop in $filesMap) {
  ...
  Backup-FileIfExists -Path $target -BackupRoot $backupRoot
}
...
Write-JsonFile -Path (Join-Path $RepoRoot $Manifest.filesToCreateOrUpdate.roomData) -Data $roomData
...
Write-JsonFile -Path (Join-Path $RepoRoot $Manifest.filesToCreateOrUpdate.cardData) -Data $cardData
...
Write-JsonFile -Path (Join-Path $RepoRoot $Manifest.filesToCreateOrUpdate.chipData) -Data $chipData
...
Write-JsonFile -Path (Join-Path $RepoRoot $Manifest.filesToCreateOrUpdate.avatarSeatData) -Data $avatarData
...
Write-JsonFile -Path (Join-Path $RepoRoot $Manifest.filesToCreateOrUpdate.watchUIData) -Data $watchData
...
Write-JsonFile -Path (Join-Path $RepoRoot $Manifest.filesToCreateOrUpdate.skyData) -Data $skyData
...
Write-JsonFile -Path $featureFlagPath -Data $featureData
