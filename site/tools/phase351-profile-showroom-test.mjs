...
if (manifest.release_ready !== true
    || manifest.apk_version_name !== '0.1.0-rc2'
    || manifest.apk_version_code !== 2
    || manifest.force_update !== false
    || manifest.show_update_prompt !== false
    || manifest.manual_update_only !== true) errors.push('manifest-apk-policy');
if (release.releaseReady !== true
    || release.apkVersionName !== '0.1.0-rc2'
    || release.apkVersionCode !== 2
    || release.forceUpdate !== false
    || release.showUpdatePrompt !== false
    || release.manualUpdateOnly !== true) errors.push('release-apk-policy');
...
console.log(JSON.stringify({
  ...
  gameRelease: manifest.build,
  apk: { versionName: release.apkVersionName, versionCode: release.apkVersionCode, releaseReady: true, manualUpdateOnly: true }
}, null, 2));
