 ...
 */
(function(){
  var BUILD = 'PHASE-255-QUEST-LOCOMOTION-TELEPORT-WATCH-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase255-quest-locomotion-watch').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase255-quest-locomotion-watch').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase255-quest-locomotion-watch').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase255-quest-locomotion-watch-' + Date.now();
