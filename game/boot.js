 ...
 */
(function(){
  var BUILD = 'PHASE-257-ALIGNMENT-PORTAL-KIOSK-TABLE-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase257-alignment-lock').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase257-alignment-lock').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase257-alignment-lock').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase257-alignment-lock-' + Date.now();
