 ...
 */
(function(){
  var BUILD = 'PHASE-270-ASSET-PATH-LOADER-SMOOTH-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase270-asset-path-loader-smooth').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase270-asset-path-loader-smooth').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase270-asset-path-loader-smooth').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase270-asset-path-loader-smooth-' + Date.now();
