 ...
 */
(function(){
  var BUILD = 'PHASE-259-VR-INTERACTION-EVERYTHING-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase259-vr-interaction').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase259-vr-interaction').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase259-vr-interaction').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase259-vr-interaction-' + Date.now();
