 ...
 */
(function(){
  var BUILD = 'PHASE-254-BOOT-SHIELD-XR-LOCOMOTION-HOTFIX';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase254-boot-hotfix').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase254-boot-hotfix').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase254-boot-hotfix').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase254-boot-hotfix-' + Date.now();
