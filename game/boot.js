 ...
 */
(function(){
  var BUILD = 'PHASE-264-MODEL-ASSET-RESTORE-AND-PATH-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase264-model-asset-path-lock').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase264-model-asset-path-lock').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase264-model-asset-path-lock').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase264-model-asset-path-lock-' + Date.now();
