 ...
 */
(function(){
  var BUILD = 'PHASE-265-BOOT-VISIBLE-LOBBY-SHELL-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase265-visible-lobby-shell').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase265-visible-lobby-shell').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase265-visible-lobby-shell').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase265-visible-lobby-shell-' + Date.now();
