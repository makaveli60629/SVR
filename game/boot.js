...
(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase245').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase245').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  import('./main.js?v=phase245').then(function(){ imported = true; setStatus('Game module loaded. Building sceneâ€¦'); }).catch(function(error){ imported = false; showRecovery('Failed to import main game module. Booting screen stopped by recovery guard.', error, false); startFallback('Failed to import main game module.', error); });
})();
