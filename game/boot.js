 ...
 */
(function(){
  var BUILD = 'PHASE-256-TRUE-CHIP-GRAB-PHYSICS-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase256-chip-physics').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase256-chip-physics').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase256-chip-physics').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase256-chip-physics-' + Date.now();
