 ...
 */
(function(){
  var BUILD = 'PHASE-271-TELEPORT-VIEW-PERFORMANCE-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase271-teleport-view-performance').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase271-teleport-view-performance').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase271-teleport-view-performance').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase271-teleport-view-performance-' + Date.now();
