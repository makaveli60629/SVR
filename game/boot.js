 ...
 */
(function(){
  var BUILD = 'PHASE-266-EARLY-RENDER-WORLD-TIMEOUT-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase266-early-render-world-timeout').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase266-early-render-world-timeout').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase266-early-render-world-timeout').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase266-early-render-world-timeout-' + Date.now();
