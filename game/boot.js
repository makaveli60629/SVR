 ...
 */
(function(){
  var BUILD = 'PHASE-261-VR-INTERACTION-REPAIR-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase261-vr-interaction-repair').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase261-vr-interaction-repair').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase261-vr-interaction-repair').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase261-vr-interaction-repair-' + Date.now();
