 ...
 */
(function(){
  var BUILD = 'PHASE-262-POKER-RIGHT-DEAL-TABLE-READABILITY-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase262-poker-table-readability').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase262-poker-table-readability').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase262-poker-table-readability').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase262-poker-table-readability-' + Date.now();
