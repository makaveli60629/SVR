 ...
 */
(function(){
  var BUILD = 'PHASE-269-RUNTIME-SHIELD-INSTALL-FAILOPEN-LOCK';
  ...
  function startFallback(reason, detail){
    ...
    import('./modules/boot_fallback.js?v=phase269-runtime-shield-failopen').then(function(){
  ...
  import('./modules/boot_route_recovery.js?v=phase269-runtime-shield-failopen').catch(function(error){ softReport('Boot route recovery module failed.', error); });
  import('./modules/boot_route_health.js?v=phase269-runtime-shield-failopen').catch(function(error){ softReport('Boot route health module failed.', error); });
  ...
  document.addEventListener('click', function(event){
    ...
    if (action === 'cache') location.href = './index.html?v=phase269-runtime-shield-failopen-' + Date.now();
