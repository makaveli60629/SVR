...
const LABEL = "UPDATE-3.0-PHASE-197-LOBBY-RECOVERY-LOCK";
...
function sync(){
  ...
  window.SVR_PHASE197 = { build: LABEL, active: true, overlayScriptsRemoved: true, handOverlayDisabled: true };
...
function cleanOldVisuals(){
  ...
  const keep = /PHASE197|PHASE196|PHASE195|PHASE191|PHASE190|PHASE178|PHASE177|PGA|REIKI|WELLNESS|SPONSOR|STORE|SCORPION|LEGEND|Watch|Teleport|Hand|Controller|Moon|Mars|Star/i;
  scene.traverse((obj)=>{
