...
function sync(){
  ...
  window.SVR_PHASE220 = { build: LABEL, active: true, upstairsDestinationFlow: true, demoCaptureSpots: true };
  window.SVR_PHASE221 = { build: LABEL, active: true, moonTextureBumpPolish: true, uploadedMoonTextureReference: true };
