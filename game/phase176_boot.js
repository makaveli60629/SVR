...
function sync(){
  ...
  window.SVR_PHASE226 = Object.assign(window.SVR_PHASE226 || {}, { build: LABEL, active: true, bootSynced: true });
  window.SVR_UPDATE31 = Object.assign(window.SVR_UPDATE31 || {}, { build: LABEL, active: true, phase: "3.1-F", bootSynced: true, singleRuntimeLock: true, questControllerVisual: true });
