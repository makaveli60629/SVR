...
function sync(){
  ...
  window.SVR_PHASE195 = { build: LABEL, active: true, cleanGeometryLobby: true };
...
function cleanOldVisuals(){
  ...
  const keep = /PHASE195|PHASE191|PHASE190|PHASE178|PHASE177|PGA|REIKI|WELLNESS|SPONSOR|STORE|SCORPION|LEGEND|Watch|Teleport|Hand|Controller|Moon|Mars|Star/i;
  scene.traverse((obj)=>{
