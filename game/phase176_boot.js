...
function sync(){
  ...
  window.SVR_PHASE206 = { build: LABEL, active: true, faceOverlayRemoved: true, phase204VisualGuideDisabled: true };
...
function cleanOldVisuals(){
  ...
  if (!scene) return;
  const old = [/PHASE176/i,/PHASE179/i,/PHASE183/i,/PHASE184/i,/PHASE185/i,/PHASE188/i,/PHASE189/i,/PHASE204_VISUAL_GUIDE/i,/PHASE204_GUIDANCE/i,/PHASE204_FEEDBACK/i,/FACE_OVERLAY/i,/BLACK_OVERLAY/i,/VIEW_OVERLAY/i,/building/i,/skyline/i,/tower/i,/city/i,/phase123/i,/phase164/i,/phase168/i,/phase171/i,/phase173/i,/phase175/i,/picture/i,/billboard/i];
  const keep = /PHASE206|PHASE205|PHASE203|PHASE202|PHASE201|PHASE200|PHASE199|PHASE198|PHASE197|PHASE196|PHASE195|PHASE191|PHASE190|PHASE178|PHASE177|PGA|REIKI|WELLNESS|SPONSOR|STORE|SCORPION|LEGEND|Watch|Teleport|Hand|Controller|Moon|Mars|Star/i;
  scene.traverse((obj)=>{
...
setInterval(()=>{ sync(); cleanOldVisuals(); }, 1200);
