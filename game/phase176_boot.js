...
function sync(){
  ...
  window.SVR_PHASE201 = { build: LABEL, active: true, hubContentRestore: true, adSlotsRestored: true, approvalSafe: true };
...
function cleanOldVisuals(){
  ...
  const keep = /PHASE201|PHASE200|PHASE199|PHASE198|PHASE197|PHASE196|PHASE195|PHASE191|PHASE190|PHASE178|PHASE177|PGA|REIKI|WELLNESS|SPONSOR|STORE|SCORPION|LEGEND|Watch|Teleport|Hand|Controller|Moon|Mars|Star/i;
  scene.traverse((obj)=>{
