import "./update31_version_sync_phase228.js";
...
function sync(){
  ...
  window.SVR_PHASE228 = Object.assign(window.SVR_PHASE228 || {}, { build: LABEL, active: true, bootSynced: true, cacheBustedRuntime: true });
  window.SVR_UPDATE31 = Object.assign(window.SVR_UPDATE31 || {}, { build: LABEL, active: true, phase: "3.1-H", bootSynced: true, cacheBustedModules: true, handsFistTeleport: true });
...
function cleanOldVisuals(){
  ...
  const keep = /UPDATE31H|UPDATE31G|UPDATE31F|UPDATE31E|UPDATE31D|PHASE228|PHASE227|PHASE226|PHASE225|PHASE224|PHASE222|PHASE220|PHASE219|PHASE218|PHASE217|PHASE216|PHASE215|PHASE214|PHASE213|PHASE212|PHASE211|PHASE208|PHASE207|PHASE206|PHASE205|PHASE204|PHASE203|PHASE202|PHASE201|PHASE200|PHASE199|PHASE198|PHASE197|PHASE196|PHASE195|PHASE191|PHASE190|PHASE178|PHASE177|PGA|REIKI|WELLNESS|SPONSOR|STORE|SCORPION|LEGEND|Watch|Teleport|Hand|Controller|Moon|Mars|Star/i;
  const toHide = [];
  scene.traverse((obj)=>{
