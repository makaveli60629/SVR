...
function sync(){
  ...
  window.SVR_PHASE224 = Object.assign(window.SVR_PHASE224 || {}, { build: LABEL, active: true, bootSynced: true });
  window.SVR_UPDATE31 = Object.assign(window.SVR_UPDATE31 || {}, { build: LABEL, active: true, phase: "3.1-D", bootSynced: true, questAlignmentFix: true });
