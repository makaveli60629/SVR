...
function stamp(){
  window.SVR_PHASE260 = { build: LABEL, active: true, romanCanopyFinal: true, archwayLobbyStyle: true, hudCleanup: true, sceneCleanup: true, siteTouched: false, checkedAt: new Date().toISOString() };
