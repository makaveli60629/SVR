...
for (const [token, label] of [
  ...
  ['phase366_android_physical_device_viewport_acceptance_lock.js', 'platform-phase366-device-module'],
  ...
  ['phase366-android-critical-load-order', 'phase366-critical-order-validator'],
  ['phase366-android-device-acceptance-not-last', 'phase366-last-validator'],
  ['phase366-android-background-deferred-work', 'zero-deferred-error-label']
...
console.log(JSON.stringify({
  ...
  platformVersion,
  controller: 'single-visible-phase347-authority-repaired-by-phase365-and-calibrated-by-phase366',
