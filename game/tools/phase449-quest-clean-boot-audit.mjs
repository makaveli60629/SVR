...
assert.match(room,/PHASE200_ORDERED_GRAND_LOBBY_ROOT/);
assert.match(room,/PHASE453_DIRECT_TABLE_ROOM/);
assert.match(room,/SVR_TELEPORT_DISABLED/);
assert.match(room,/SVR_PHASE446_SWEEP/);
assert.match(loader,/holdQuestStage/);
assert.match(loader,/if \(!holdQuestStage\)/);
