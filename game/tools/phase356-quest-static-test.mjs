...
assert.match(uploadedTable, /PHASE356_QUEST_UPLOADED_ASSET_CONTAINER/);
assert.match(uploadedTable, /Array\.from\(materials/);
assert.match(uploadedTable, /window\.SVR_TABLE_AUTHORITY = object/);
assert.match(uploadedTable, /SVR_PHASE356_UPLOADED_TABLE_QA/);
assert.doesNotMatch(uploadedTable, /PHASE356_QUEST_UPLOADED_TABLE_AUTHORITY_ROOT/);
