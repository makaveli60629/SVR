...
import { PHASE_111_BUILD, routeLabel, PHASE_101_VR_RUNTIME_CORRECTION_LOCK, PHASE_106_HOLOCTX_BOOT_FIX_LOCK, PHASE_111_SKY_ESPRESSO_FACE_CENTER_LOCK } from "./modules/private_room_registry.js";

window.__SVR_PHASE111_RUNTIME_LOCK = PHASE_111_SKY_ESPRESSO_FACE_CENTER_LOCK;
...
setStatus(AUTOCAM ? "Live preview ready" : `Ready. ${PHASE_111_BUILD}: sky raised, espresso wall faces center, real ad texture restored.`, { force: true });
