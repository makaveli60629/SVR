...
## Test
Open `/game/?v=phase252`. The top status should move from `Boot guard: loading game module…` to scene loading and then ready. If import fails, the user sees a recovery panel instead of being stuck on Booting.
