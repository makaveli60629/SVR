...
The Reiki Hub/storefront is restored from the user-provided backup file:

`gameback up reiki.zip`

This is the correct old + new remodeled Reiki hub/storefront module with the hologram/video carousel button. The screenshot-confirmed Phase 107 look remains the visual target, and the backup package is the grounded source for the files.
