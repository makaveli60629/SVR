...
## Phase 199
- PHASE-233-OPTIONAL-MODULE-LOADER-LOCK: dealer/blind state + safe rebuy continuity. Public page untouched.


## Phase 199
- PHASE-233-OPTIONAL-MODULE-LOADER-LOCK: player decision aid, pot-odds pressure hints, and backend telemetry hook. Public page untouched.
