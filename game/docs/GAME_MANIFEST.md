...
## Phase 199
- PHASE-244-MAIN-RUNTIME-CATCH-FIX-LOCK: dealer/blind state + safe rebuy continuity. Public page untouched.


## Phase 199
- PHASE-244-MAIN-RUNTIME-CATCH-FIX-LOCK: player decision aid, pot-odds pressure hints, and backend telemetry hook. Public page untouched.
