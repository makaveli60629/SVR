...
## Phase 199
- PHASE-236-VR-INPUT-DIAGNOSTIC-LOCK: dealer/blind state + safe rebuy continuity. Public page untouched.


## Phase 199
- PHASE-236-VR-INPUT-DIAGNOSTIC-LOCK: player decision aid, pot-odds pressure hints, and backend telemetry hook. Public page untouched.
