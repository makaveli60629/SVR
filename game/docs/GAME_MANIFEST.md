...
## Phase 199
- PHASE-217-AUTO-APPLY-GIT-WRAPPER-FIX-LOCK: dealer/blind state + safe rebuy continuity. Public page untouched.


## Phase 199
- PHASE-217-AUTO-APPLY-GIT-WRAPPER-FIX-LOCK: player decision aid, pot-odds pressure hints, and backend telemetry hook. Public page untouched.
