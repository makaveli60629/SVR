# QA Phase 203 — Enterprise Bridge Recorder Fix

- [ ] Open `/game/?v=phase203-recordfix`.
...
- [ ] Press `V` for deploy verifier.
- [ ] Press `T` for smoke test.
- [ ] Press `Q` for runtime QA.
- [ ] Confirm public Matrix launch page was not touched.
