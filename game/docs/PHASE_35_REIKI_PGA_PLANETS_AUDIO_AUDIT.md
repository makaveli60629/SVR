...
## Changes
- Restored SVR Wellness partner image and logo to the Reiki storefront.
- Upgraded the Reiki storefront three-column content with more professional partner/services/highlights messaging.
...
## Control lock preserved
- Meta hands only
- no watch
- no fake arms
- fist teleport fallback
- left-stick movement
