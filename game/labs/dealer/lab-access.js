...
async function launch() {
  ...
  await import('./dealer-lab-v427.js?v=phase437');
  await import('./dealer-scale-authority-phase435.js?v=phase437');
  await import('./table-surface-authority-phase437.js?v=phase437');
}
