...
function makeVideoPanel(){
  ...
  const sources=['./assets/video/reiki-hologram.mp4','./assets/video/riki-hologram.mp4','./assets/media/reiki-hologram.mp4','./assets/media/riki-hologram.mp4','./assets/video/shyona-royston-reiki-interview.mp4','./assets/video/shaira-royston-riki-interview.mp4','./assets/video/hologram.mp4']; let i=0, loaded=false;
