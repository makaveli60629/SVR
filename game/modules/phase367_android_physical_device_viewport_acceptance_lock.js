export const BUILD = 'PHASE-367-ANDROID-PHYSICAL-DEVICE-VIEWPORT-ACCEPTANCE-LOCK';
...
function installStyle() {
  ...
  style.textContent = `
:root{--svr367-vw:100vw;--svr367-vh:100vh;--svr367-offset-x:0px;--svr367-offset-y:0px;--svr367-ui-scale:1}
html,body,#app{width:var(--svr367-vw)!important;height:var(--svr367-vh)!important;max-height:var(--svr367-vh)!important}
body.svr367-device-ready{overscroll-behavior:none;-webkit-text-size-adjust:100%}
body.svr367-seated #svr347Actions{max-height:calc(var(--svr367-vh) - env(safe-area-inset-top) - env(safe-area-inset-bottom) - 24px)!important}
body.svr367-seated #svr347Hole{bottom:max(12px,calc(env(safe-area-inset-bottom) + 8px))!important}
body.svr367-seated #svr363Bankroll{top:max(12px,calc(env(safe-area-inset-top) + 8px))!important;right:max(10px,calc(env(safe-area-inset-right) + 8px))!important}
body.svr367-seated #svr357TurnPanel{top:max(52px,calc(env(safe-area-inset-top) + 44px))!important}
body.svr367-seated #svr365BrandSlot{left:max(6px,env(safe-area-inset-left))!important;top:max(6px,env(safe-area-inset-top))!important;transform:scale(.92);transform-origin:top left}
body.svr367-seated #svr347Actions button{min-height:44px;touch-action:manipulation}
@media(max-height:430px) and (orientation:landscape){body.svr367-seated #svr347Actions{width:min(40vw,286px)!important;right:max(8px,env(safe-area-inset-right))!important}body.svr367-seated #svr347Hole{transform:scale(.9)!important;transform-origin:bottom left}body.svr367-seated #svr363Bankroll{transform:scale(.88);transform-origin:top right}}
`;
...
function applyViewport(reason = 'viewport') {
  ...
  root.style.setProperty('--svr367-ui-scale', String(Math.max(.82, Math.min(1.08, next.width / 412))));
