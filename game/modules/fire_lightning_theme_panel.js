(function(){
  ...
  function render(show=true){
    ...
    p.innerHTML = `
      ...
      <div><b>Arch:</b> removed spawn teleport-machine arch; hand glow only</div>
      ...
      <h4>Test</h4>
      <ol>
        <li>Enter the lobby and look toward the main walkway: the spawn arch should be removed; hand glow remains visible.</li>
