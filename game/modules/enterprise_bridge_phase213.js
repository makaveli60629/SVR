...
(function(){
  ...
  bridge.queue = bridge.queue || function(type, payload){ try { (window.__SVR_BRIDGE_QUEUE__ = window.__SVR_BRIDGE_QUEUE__ || []).push({ type, payload, at:new Date().toISOString(), build:'PHASE-222-POST-DEPLOY-CHECKLIST-LOCK' }); } catch(_){} };
