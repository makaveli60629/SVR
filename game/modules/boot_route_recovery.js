...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase252-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase252'],
    ...
    ['Cam 3 Preview','./cam3.html?v=phase252']
  ];
