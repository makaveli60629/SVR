...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase230-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase230'],
    ['PGA Drive','./pga-drive.html?v=phase230'],
    ['Chip / Putt','./chip-putt.html?v=phase230'],
    ['Reiki Room','./reiki.html?v=phase230'],
    ['VR Store','./store-room.html?v=phase230'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase230'],
    ['Cam 3 Preview','./cam3.html?v=phase230']
  ];
