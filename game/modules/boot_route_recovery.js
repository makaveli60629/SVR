...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase224-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase224'],
    ['PGA Drive','./pga-drive.html?v=phase224'],
    ['Chip / Putt','./chip-putt.html?v=phase224'],
    ['Reiki Room','./reiki.html?v=phase224'],
    ['VR Store','./store-room.html?v=phase224'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase224'],
    ['Cam 3 Preview','./cam3.html?v=phase224']
  ];
