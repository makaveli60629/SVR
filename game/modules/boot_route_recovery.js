...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase223-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase223'],
    ['PGA Drive','./pga-drive.html?v=phase223'],
    ['Chip / Putt','./chip-putt.html?v=phase223'],
    ['Reiki Room','./reiki.html?v=phase223'],
    ['VR Store','./store-room.html?v=phase223'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase223'],
    ['Cam 3 Preview','./cam3.html?v=phase223']
  ];
