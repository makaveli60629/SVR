...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase226-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase226'],
    ['PGA Drive','./pga-drive.html?v=phase226'],
    ['Chip / Putt','./chip-putt.html?v=phase226'],
    ['Reiki Room','./reiki.html?v=phase226'],
    ['VR Store','./store-room.html?v=phase226'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase226'],
    ['Cam 3 Preview','./cam3.html?v=phase226']
  ];
