...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase234-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase234'],
    ['PGA Drive','./pga-drive.html?v=phase234'],
    ['Chip / Putt','./chip-putt.html?v=phase234'],
    ['Reiki Room','./reiki.html?v=phase234'],
    ['VR Store','./store-room.html?v=phase234'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase234'],
    ['Cam 3 Preview','./cam3.html?v=phase234']
  ];
