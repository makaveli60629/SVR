...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase233-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase233'],
    ['PGA Drive','./pga-drive.html?v=phase233'],
    ['Chip / Putt','./chip-putt.html?v=phase233'],
    ['Reiki Room','./reiki.html?v=phase233'],
    ['VR Store','./store-room.html?v=phase233'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase233'],
    ['Cam 3 Preview','./cam3.html?v=phase233']
  ];
