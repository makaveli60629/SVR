...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase236-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase236'],
    ['PGA Drive','./pga-drive.html?v=phase236'],
    ['Chip / Putt','./chip-putt.html?v=phase236'],
    ['Reiki Room','./reiki.html?v=phase236'],
    ['VR Store','./store-room.html?v=phase236'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase236'],
    ['Cam 3 Preview','./cam3.html?v=phase236']
  ];
