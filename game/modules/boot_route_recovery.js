...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase242-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase242'],
    ['PGA Drive','./pga-drive.html?v=phase242'],
    ['Chip / Putt','./chip-putt.html?v=phase242'],
    ['Reiki Room','./reiki.html?v=phase242'],
    ['VR Store','./store-room.html?v=phase242'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase242'],
    ['Cam 3 Preview','./cam3.html?v=phase242']
  ];
