...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase238-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase238'],
    ['PGA Drive','./pga-drive.html?v=phase238'],
    ['Chip / Putt','./chip-putt.html?v=phase238'],
    ['Reiki Room','./reiki.html?v=phase238'],
    ['VR Store','./store-room.html?v=phase238'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase238'],
    ['Cam 3 Preview','./cam3.html?v=phase238']
  ];
