/* SVR Phase 213 - Boot Route Recovery Link Lock
...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase213-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase213'],
    ...
    ['Cam 3 Preview','./cam3.html?v=phase213']
  ];
