...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase225-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase225'],
    ['PGA Drive','./pga-drive.html?v=phase225'],
    ['Chip / Putt','./chip-putt.html?v=phase225'],
    ['Reiki Room','./reiki.html?v=phase225'],
    ['VR Store','./store-room.html?v=phase225'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase225'],
    ['Cam 3 Preview','./cam3.html?v=phase225']
  ];
