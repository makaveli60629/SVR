...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase244-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase244'],
    ['PGA Drive','./pga-drive.html?v=phase244'],
    ['Chip / Putt','./chip-putt.html?v=phase244'],
    ['Reiki Room','./reiki.html?v=phase244'],
    ['VR Store','./store-room.html?v=phase244'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase244'],
    ['Cam 3 Preview','./cam3.html?v=phase244']
  ];
