...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase229-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase229'],
    ['PGA Drive','./pga-drive.html?v=phase229'],
    ['Chip / Putt','./chip-putt.html?v=phase229'],
    ['Reiki Room','./reiki.html?v=phase229'],
    ['VR Store','./store-room.html?v=phase229'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase229'],
    ['Cam 3 Preview','./cam3.html?v=phase229']
  ];
