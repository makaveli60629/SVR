...
(function(){
  ...
  const routeList = [
    ['Lobby hard refresh','./index.html?v=phase218-route-'+Date.now()],
    ['Lobby no cache','./index.html?nocache='+Date.now()],
    ['Scorpion Poker','./scorpion.html?v=phase218'],
    ['PGA Drive','./pga-drive.html?v=phase218'],
    ['Chip / Putt','./chip-putt.html?v=phase218'],
    ['Reiki Room','./reiki.html?v=phase218'],
    ['VR Store','./store-room.html?v=phase218'],
    ['Smoker Lounge','./smoker-lounge.html?v=phase218'],
    ['Cam 3 Preview','./cam3.html?v=phase218']
  ];
