...
export function openPrivateScene(key){
  const map = { reikiRoom:'./reiki.html?v=phase91', pgaDrive:'./range.html?v=phase91', pgaChipPutt:'./chip-putt.html?v=phase91', chipPutt:'./chip-putt.html?v=phase91', storeRoom:'./store-room.html?v=phase91', smokerLounge:'./smoker-lounge.html?v=phase91', scorpion:'./scorpion.html?v=phase91' };
  const href = map[key]; if (!href) return false; location.href = href; return true;
}
