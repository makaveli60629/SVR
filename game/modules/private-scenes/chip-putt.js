...
const { scene, ring, renderer, camera } = bootPrivateScene({ title: 'SVR Chip + Putt', subtitle: 'Private short-game room scaffold • putting / chipping', accent: 0xf6d35c });
if ('chip-putt.html' === 'pga-drive.html' || 'chip-putt.html' === 'range.html') {
