...
const { scene, ring, renderer, camera } = bootPrivateScene({ title: 'SVR PGA Range', subtitle: 'Alias for PGA Drive • private scene', accent: 0x54ff95 });
if ('range.html' === 'pga-drive.html' || 'range.html' === 'range.html') {
