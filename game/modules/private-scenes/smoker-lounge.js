...
const { scene, ring, renderer, camera } = bootPrivateScene({ title: 'SVR Smoker Lounge', subtitle: 'Private social lounge scaffold • replay board ready', accent: 0xb98cff });
if ('smoker-lounge.html' === 'pga-drive.html' || 'smoker-lounge.html' === 'range.html') {
