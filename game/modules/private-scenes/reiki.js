...
const { scene, ring, renderer, camera } = bootPrivateScene({ title: 'SVR Reiki Room', subtitle: 'Private meditation scene • AWAITING APPROVAL • no sponsor branding', accent: 0xff304d });
if ('reiki.html' === 'pga-drive.html' || 'reiki.html' === 'range.html') {
