(function(){
  ...
  "./auto_apply_status.js?v=phase238",
  "./auto_apply_verify.js?v=phase238",
  "./one_command_deploy_health.js?v=phase238",
  "./one_command_runbook.js?v=phase238",
  "./post_deploy_checklist.js?v=phase238",
  "./tester_launch_card.js?v=phase238",
  "./qa_shortcut_index.js?v=phase238",
  "./pilot_handoff_card.js?v=phase238",
  "./pilot_ready_summary.js?v=phase238",
  "./pilot_issue_template.js?v=phase238",
  "./pilot_feedback_export.js?v=phase238",
  "./power_deploy_watcher.js?v=phase238",
  "./power_deploy_wait_log.js?v=phase238",
  "./power_deploy_smoke_probe.js?v=phase238",
  "./vr_input_spawn_clear_recovery.js?v=phase238",
  "./vr_input_diagnostic.js?v=phase238",
  "./quest_input_autocalibration.js?v=phase238",
  "./hand_teleport_pinch_destination.js?v=phase238",
  "./main_import_recovery.js?v=phase238",
  "./bridge_alias_recovery.js?v=phase238",
  "./bridge_proxy.js",
  "./event_firewall.js",
  ...
  "./auto_apply_git_wrapper_fix.js?v=phase238"
];
  const state = {
    build: BUILD,
    phase: 233,
