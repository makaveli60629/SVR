...
powershell -ExecutionPolicy Bypass -File "$env:USERPROFILE\\Downloads\\SVR-AUTO-APPLY-NEXT-PHASE218.ps1"</pre><div><b>After push:</b> GitHub → Actions → Auto Deploy → Run workflow → main</div><div><b>Test:</b> /game/?v=phase229-autoapplystatus</div>`;
