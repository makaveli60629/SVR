/* PHASE-407-MOBILE-FIT-LOGIN-BURN-LOCK | Phase 408 inline burn compatible | Phase 409 turn/fit layer | Phase 410 human input layer | Phase 411 tournament/bot/action layer | Phase 412 account gate/pro polish */
...
function ensurePhase412Layer(){
  ...
  document.querySelectorAll('a[href*="tournaments.html"]').forEach(a=>{try{const u=new URL(a.href,location.href);u.searchParams.set('v','phase412');a.href=u.pathname+u.search}catch{}});
