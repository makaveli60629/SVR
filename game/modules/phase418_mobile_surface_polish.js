...
function ensureQuickControls(){
  ...
  if(!host){host=document.createElement('div');host.id='phase418QuickControls';host.className='phase418-quick-controls';host.setAttribute('aria-label','Quick table controls');host.innerHTML='<button id="phase418QuickMic" class="phase418-quick-control mic" type="button">MIC / VOX</button><a id="phase418Profile" class="phase418-quick-control account" href="/site/profile.html?v=phase430&source=mobile-table">PROFILE</a><a id="phase418Login" class="phase418-quick-control account" href="/site/login.html?next=/game/android.html%3Fchannel%3Dstable%26v%3Dphase431">PLAYER LOGIN</a><a id="phase418Register" class="phase418-quick-control account" href="/site/login.html?mode=register&next=/game/android.html%3Fchannel%3Dstable%26v%3Dphase431">CREATE PLAYER</a>';(flow||$('#phase404DecisionStrip'))?.insertAdjacentElement('afterend',host)||raise.prepend(host)}
...
/* Phase 431 is the final viewport/layout authority and loads after every legacy mobile layer. */
(function loadPhase431(){
  if(!document.querySelector('link[data-svr-phase431]')){const link=document.createElement('link');link.rel='stylesheet';link.href='/game/styles/phase431_mobile_play_fit.css?v=phase431';link.dataset.svrPhase431='1';document.head.appendChild(link)}
  import('./phase431_mobile_play_fit.js?v=phase431').catch(error=>{window.SVR_PHASE431_MOBILE_PLAY_IMPORT_ERROR=String(error?.message||error)});
})();
