(function(){
  ...
  async function run(){
    ...
    const phaseOk = combined.includes("PHASE-252-FORWARD-RESTORE-QUEST-POKER-LOCK") || combined.includes('"phase": 252') || combined.includes('"phase": 252');
  ...
  function render(show){
    ...
    p.innerHTML = `
      ...
      <ol>
        ...
        <li>Phase 244 appears in version/deploy markers.</li>
