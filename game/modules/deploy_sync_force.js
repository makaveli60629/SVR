(function(){
  ...
  async function probe(label, url, expect){
    const full = url + (url.includes("?") ? "&" : "?") + "bust=phase244-" + Date.now();
  ...
  async function run(){
    ...
    state.checks = [
      ...
      await probe("boot.js", "./boot.js?v=phase244", "main.js?v=phase244"),
      await probe("main.js", "./main.js?v=phase244", "optional_module_loader"),
