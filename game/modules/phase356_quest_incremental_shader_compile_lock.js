...
export const BUILD = 'PHASE-356-QUEST-INCREMENTAL-SHADER-COMPILE-LOCK';
...
function install() {
  ...
  prototype.compile = function phase356QuestDeferredCompile() {
    state.compileCallsDeferred += 1;
    return this;
  };

  prototype.compileAsync = async function phase356QuestDeferredCompileAsync() {
    state.compileAsyncCallsDeferred += 1;
    return this;
  };

  window.SVR_PHASE356_QUEST_SHADER_STATE = state;
  return state;
}
...
window.SVR_PHASE356_QUEST_SHADER_QA = qa;
window.SVR_PHASE356_QUEST_SHADER_RESTORE = restore;
