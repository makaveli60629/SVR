(function(){
  ...
  const dependencies = [
    "./main.js?v=phase244",
    "./modules/enterprise_bridge_phase244.js",
    "./modules/power_deploy_wait_log.js?v=phase244",
    "./modules/power_deploy_watcher.js?v=phase244",
    "./modules/pilot_feedback_export.js?v=phase244"
  ];
