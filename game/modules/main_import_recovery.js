(function(){
  ...
  const dependencies = [
    "./main.js?v=phase252",
    "./modules/enterprise_bridge_phase252.js",
    "./modules/power_deploy_wait_log.js?v=phase252",
    "./modules/power_deploy_watcher.js?v=phase252",
    "./modules/pilot_feedback_export.js?v=phase252"
  ];
  ...
  function render(show){
    ...
    p.innerHTML = `
      ...
      <div><b>Fix:</b> cache-busted enterprise bridge file restored for Phase 244.</div>
