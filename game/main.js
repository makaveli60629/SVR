...
import "./modules/enterprise_bridge_phase205.js";
...
window.dispatchEvent(new CustomEvent("svr_runtime_telemetry", { detail: { event: "boot_ready", preview: AUTOCAM, build: "PHASE-205-ENTERPRISE-BRIDGE-CACHEBUST-FIX-LOCK" } }));
window.dispatchEvent(new CustomEvent("svr_game_ready", { detail: { build: "PHASE-205-ENTERPRISE-BRIDGE-CACHEBUST-FIX-LOCK", preview: AUTOCAM, at: new Date().toISOString() } }));
