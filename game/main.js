...
const directSceneRoutes = {
  reikiRoom: "./reiki.html",
  pgaDrive: "./pga-drive.html",
  chipPutt: "./chip-putt.html",
  store: "./store-room.html",
  lounge: "./smoker-lounge.html",
  scorpion: "./scorpion.html"
};

function gotoScene(key){
  if (directSceneRoutes[key]){
    window.location.href = directSceneRoutes[key];
    return true;
  }
...
window.addEventListener("keydown", async (e)=>{
  ...
  if (e.code === "Digit7") gotoScene("chipPutt");
...
setStatus(AUTOCAM ? "Live preview ready" : "Ready. Enter VR. Hold grip/A/trigger or fist to aim teleport. Desktop scene buttons enabled. Wrist quick-jump enabled for Lobby/Seat/Reiki/PGA/Store/Lounge/Scorpion.", { force: true });
