...
import "./modules/optional_module_loader.js?v=phase238";
...
window.dispatchEvent(new CustomEvent("svr_runtime_telemetry", { detail: { event: "boot_ready", preview: AUTOCAM, build: "PHASE-238-HAND-TELEPORT-PINCH-DESTINATION-LOCK" } }));
window.dispatchEvent(new CustomEvent("svr_game_ready", { detail: { build: "PHASE-238-HAND-TELEPORT-PINCH-DESTINATION-LOCK", preview: AUTOCAM, at: new Date().toISOString() } }));
