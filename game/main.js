...
import "./modules/auto_apply_status.js?v=phase230";
import "./modules/auto_apply_verify.js?v=phase230";
import "./modules/one_command_deploy_health.js?v=phase230";
import "./modules/one_command_runbook.js?v=phase230";
import "./modules/post_deploy_checklist.js?v=phase230";
import "./modules/tester_launch_card.js?v=phase230";
import "./modules/qa_shortcut_index.js?v=phase230";
import "./modules/pilot_handoff_card.js?v=phase230";
import "./modules/pilot_ready_summary.js?v=phase230";
import "./modules/pilot_issue_template.js?v=phase230";
import "./modules/pilot_feedback_export.js?v=phase230";
import "./modules/power_deploy_watcher.js?v=phase230";
import "./modules/power_deploy_wait_log.js?v=phase230";
import "./modules/bridge_proxy.js";
import "./modules/event_firewall.js";
import "./modules/enterprise_bridge_phase230.js";
...
import "./modules/auto_apply_git_wrapper_fix.js?v=phase230";
...
window.dispatchEvent(new CustomEvent("svr_runtime_telemetry", { detail: { event: "boot_ready", preview: AUTOCAM, build: "PHASE-230-POWER-DEPLOY-WAIT-LOG-LOCK" } }));
window.dispatchEvent(new CustomEvent("svr_game_ready", { detail: { build: "PHASE-230-POWER-DEPLOY-WAIT-LOG-LOCK", preview: AUTOCAM, at: new Date().toISOString() } }));
