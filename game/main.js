...
import "./modules/auto_apply_status.js?v=phase225";
import "./modules/auto_apply_verify.js?v=phase225";
import "./modules/one_command_deploy_health.js?v=phase225";
import "./modules/one_command_runbook.js?v=phase225";
import "./modules/post_deploy_checklist.js?v=phase225";
import "./modules/tester_launch_card.js?v=phase225";
import "./modules/qa_shortcut_index.js?v=phase225";
import "./modules/pilot_handoff_card.js?v=phase225";
import "./modules/bridge_proxy.js";
import "./modules/event_firewall.js";
import "./modules/enterprise_bridge_phase225.js";
...
import "./modules/auto_apply_git_wrapper_fix.js?v=phase225";
...
window.dispatchEvent(new CustomEvent("svr_runtime_telemetry", { detail: { event: "boot_ready", preview: AUTOCAM, build: "PHASE-225-PILOT-HANDOFF-CARD-LOCK" } }));
window.dispatchEvent(new CustomEvent("svr_game_ready", { detail: { build: "PHASE-225-PILOT-HANDOFF-CARD-LOCK", preview: AUTOCAM, at: new Date().toISOString() } }));
