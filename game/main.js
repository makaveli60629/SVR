...
const pokerHudState = {
  build: "PHASE-202-BOOT-FALLBACK-CDN-RECOVERY-LOCK",
  actor: "TABLE",
  stage: "waiting",
  action: "waiting",
  remaining: 0,
...
window.dispatchEvent(new CustomEvent("svr_runtime_telemetry", { detail: { event: "boot_ready", preview: AUTOCAM, build: "PHASE-202-BOOT-FALLBACK-CDN-RECOVERY-LOCK" } }));
window.dispatchEvent(new CustomEvent("svr_game_ready", { detail: { build: "PHASE-202-BOOT-FALLBACK-CDN-RECOVERY-LOCK", preview: AUTOCAM, at: new Date().toISOString() } }));
