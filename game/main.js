...
import "./modules/enterprise_bridge_phase212.js";
...
window.dispatchEvent(new CustomEvent("svr_runtime_telemetry", { detail: { event: "boot_ready", preview: AUTOCAM, build: "PHASE-212-BOOT-DIAGNOSTIC-SNAPSHOT-LOCK" } }));
window.dispatchEvent(new CustomEvent("svr_game_ready", { detail: { build: "PHASE-212-BOOT-DIAGNOSTIC-SNAPSHOT-LOCK", preview: AUTOCAM, at: new Date().toISOString() } }));
