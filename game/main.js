...
import "./modules/optional_module_loader.js?v=phase236";
...
window.dispatchEvent(new CustomEvent("svr_runtime_telemetry", { detail: { event: "boot_ready", preview: AUTOCAM, build: "PHASE-236-VR-INPUT-DIAGNOSTIC-LOCK" } }));
window.dispatchEvent(new CustomEvent("svr_game_ready", { detail: { build: "PHASE-236-VR-INPUT-DIAGNOSTIC-LOCK", preview: AUTOCAM, at: new Date().toISOString() } }));
