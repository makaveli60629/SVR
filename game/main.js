...
import "./modules/auto_apply_status.js?v=phase222";
import "./modules/auto_apply_verify.js?v=phase222";
import "./modules/one_command_deploy_health.js?v=phase222";
import "./modules/one_command_runbook.js?v=phase222";
import "./modules/post_deploy_checklist.js?v=phase222";
import "./modules/bridge_proxy.js";
import "./modules/event_firewall.js";
import "./modules/enterprise_bridge_phase222.js";
...
import "./modules/auto_apply_git_wrapper_fix.js?v=phase222";
...
window.dispatchEvent(new CustomEvent("svr_runtime_telemetry", { detail: { event: "boot_ready", preview: AUTOCAM, build: "PHASE-222-POST-DEPLOY-CHECKLIST-LOCK" } }));
window.dispatchEvent(new CustomEvent("svr_game_ready", { detail: { build: "PHASE-222-POST-DEPLOY-CHECKLIST-LOCK", preview: AUTOCAM, at: new Date().toISOString() } }));
