...
import "./modules/auto_apply_status.js?v=phase231";
import "./modules/auto_apply_verify.js?v=phase231";
import "./modules/one_command_deploy_health.js?v=phase231";
import "./modules/one_command_runbook.js?v=phase231";
import "./modules/post_deploy_checklist.js?v=phase231";
import "./modules/tester_launch_card.js?v=phase231";
import "./modules/qa_shortcut_index.js?v=phase231";
import "./modules/pilot_handoff_card.js?v=phase231";
import "./modules/pilot_ready_summary.js?v=phase231";
import "./modules/pilot_issue_template.js?v=phase231";
import "./modules/pilot_feedback_export.js?v=phase231";
import "./modules/power_deploy_watcher.js?v=phase231";
import "./modules/power_deploy_wait_log.js?v=phase231";
import "./modules/main_import_recovery.js?v=phase231";
import "./modules/bridge_proxy.js";
import "./modules/event_firewall.js";
import "./modules/enterprise_bridge_phase231.js";
...
import "./modules/auto_apply_git_wrapper_fix.js?v=phase231";
...
window.dispatchEvent(new CustomEvent("svr_runtime_telemetry", { detail: { event: "boot_ready", preview: AUTOCAM, build: "PHASE-231-MAIN-IMPORT-RECOVERY-LOCK" } }));
window.dispatchEvent(new CustomEvent("svr_game_ready", { detail: { build: "PHASE-231-MAIN-IMPORT-RECOVERY-LOCK", preview: AUTOCAM, at: new Date().toISOString() } }));
