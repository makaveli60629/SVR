const SVR_CACHE='svr-poker-phase396-seated-quest-android-dealer-v1';
const CORE=[
  '/offline.html','/logo.png','/manifest.webmanifest?v=phase396','/site-public-hooks.js?v=phase396','/launch-quest.css?v=phase396',
  ...
  '/game/android.html?channel=stable&v=phase396','/game/android-tabletop.html?v=phase396','/game/android-stable.html?v=phase396',
  '/game/styles/phase393_android_table_layout.css?v=phase393','/game/styles/phase394_android_table_polish.css?v=phase394','/game/styles/phase396_android_burn_dealer_polish.css?v=phase396','/game/modules/phase393_android_common.js?v=phase393','/game/modules/phase393_android_evaluator.js?v=phase393','/game/modules/phase393_android_gameplay.js?v=phase393','/game/modules/phase394_android_table_polish.js?v=phase394','/game/modules/phase396_android_burn_dealer_polish.js?v=phase396',
...
self.addEventListener('message',event=>{if(['SKIP_WAITING','PHASE391_CLEAR','PHASE392_CLEAR','PHASE393_CLEAR','PHASE394_CLEAR','PHASE395_CLEAR','PHASE396_CLEAR'].includes(event?.data?.type)){event.waitUntil(caches.keys().then(keys=>Promise.all(keys.map(key=>caches.delete(key)))).then(()=>self.skipWaiting()))}});
