const SVR_CACHE='svr-poker-phase393-dual-device-calibration-v1';
const CORE=[
  '/offline.html','/logo.png','/manifest.webmanifest?v=phase393','/site-public-hooks.js?v=phase393',
  '/game/quest.html?v=phase393','/game/index.html?platform=quest&v=phase393&direct=1&autoseat=1&questfix=1&clean=1',
  '/game/modules/phase393_quest_table_eric_seat_calibration.js?v=phase393','/game/modules/phase393_quest_table_surface.js?v=phase393','/game/modules/phase393_quest_eric_seat.js?v=phase393',
  '/game/android.html?channel=stable&v=phase393','/game/android-tabletop.html?v=phase393','/game/android-stable.html?v=phase393',
  '/game/styles/phase393_android_table_layout.css?v=phase393','/game/modules/phase393_android_common.js?v=phase393','/game/modules/phase393_android_evaluator.js?v=phase393','/game/modules/phase393_android_gameplay.js?v=phase393',
  '/game/camera3-showcase.html?v=phase393','/site/avatar.html?v=phase393','/site/profile.html?v=phase393'
];
...
self.addEventListener('message',event=>{if(['SKIP_WAITING','PHASE391_CLEAR','PHASE392_CLEAR','PHASE393_CLEAR'].includes(event?.data?.type)){event.waitUntil(caches.keys().then(keys=>Promise.all(keys.map(key=>caches.delete(key)))).then(()=>self.skipWaiting()))}});
