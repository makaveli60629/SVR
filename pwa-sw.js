const PHASE389_PREDECESSOR='phase389-full-audit-visible-fixes';
const SVR_PWA_CACHE='svr-poker-pwa-phase390-table-geometry-cards-spawn-v1';
const CORE=[
  '/offline.html','/logo.png','/manifest.webmanifest?v=phase390','/site-public-hooks.js?v=phase390',
  '/site/avatar.html?v=phase389','/site/profile.html?v=phase389','/site/phase383-home-restore.js?v=phase390',
  ...
  '/game/quest.html?v=phase390','/game/index.html?platform=quest&v=phase390&direct=1&autoseat=1&questfix=1&clean=1',
  '/game/modules/phase388_quest_table_player_eric_authority.js?v=phase390',
  '/game/modules/phase388_quest_view_dealer_guard.js?v=phase390',
  ...
  '/game/styles/phase385_android_tabletop.css?v=phase390','/game/styles/phase389_android_responsive_layout.css?v=phase390',
  '/game/modules/phase385_android_tabletop_3d.js?v=phase390','/game/modules/phase389_android_responsive_layout.js?v=phase390'
];
...
self.addEventListener('message',event=>{if(['SKIP_WAITING','PHASE388_CLEAR','PHASE389_CLEAR','PHASE390_CLEAR'].includes(event?.data?.type)){event.waitUntil(caches.keys().then(keys=>Promise.all(keys.map(key=>caches.delete(key)))).then(()=>self.skipWaiting()));}});
